...
// Подсветка удержанного барабана рисуется по границам колонки: арта под неё в паке нет
/** Толщина обводки подсветки удержанного барабана в нативных пикселях зоны символов. */
export const HELD_FRAME_THICKNESS = 10
/** Непрозрачность заливки колонки под обводкой удержанного барабана. */
export const HELD_FRAME_FILL_ALPHA = 0.12
/** Появление подсветки удержанного барабана, мс. */
export const HELD_FRAME_FADE_MS = 200
/** Толщина диагоналей креста внутри подсветки удержанного барабана: как у вин-рамки. */
export const HELD_FRAME_CROSS_THICKNESS = WIN_FRAME_THICKNESS
/** Непрозрачность диагоналей креста. */
export const HELD_FRAME_CROSS_ALPHA = 0.35
