...
- **Slot machine** — a reel mechanics demo: five reels, three rows, up to ten paylines across
  ...
  hold-to-spin turbo, anticipation spins, and sticky-wild respins with held reels. Next up:
  hold-and-win cells and cascades. The server is the source of truth: the client presents the
  round it receives.
