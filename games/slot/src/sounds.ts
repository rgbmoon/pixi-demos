import { SHAKE_MS, SHAKE_OSCILLATIONS } from '#src/constants'
import type { LoopRecipe, SoundRecipe, SynthVoice, SynthVoiceTemplate } from '@pixi-demos/engine/audio/types'
import { createArpeggio } from '@pixi-demos/engine/audio/utils'
