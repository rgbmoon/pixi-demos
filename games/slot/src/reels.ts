import { CELL_HEIGHT, HOLD_WIN_CELLS_COUNT, REELS_COUNT, VISIBLE_SYMBOLS_COUNT } from '#src/constants'
import type { HoldWinCell, SymbolKey } from '#src/types'
import { getRandomSymbolKey } from '#src/utils'
import { GravityFallStrategy, LinearSpinStrategy , PlannedLandingStrategy  } from '@pixi-demos/reels'
import type { ReelsConfig, ReelStrategies } from '@pixi-demos/reels'
