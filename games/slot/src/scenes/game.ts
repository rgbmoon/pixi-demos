...
import { LOGO_ALIAS } from '#src/assets'
import {
  DESIGN_HEIGHT,
  DESIGN_WIDTH,
  REELS_FRAME_HEIGHT,
...
import type { BetPanelController } from '#src/controllers/hud/bet-panel'
import type { CreditLabelController } from '#src/controllers/hud/credit-label'
import type { SettingsButtonController } from '#src/controllers/hud/settings-button'
import type { SettingsModalController } from '#src/controllers/hud/settings-modal'
import type { SoundToggleButtonController } from '#src/controllers/hud/sound-toggle-button'
import type { SpinButtonController } from '#src/controllers/hud/spin-button'
import type { WinLabelController } from '#src/controllers/hud/win-label'
...
import type { SoundController } from '#src/controllers/sound'
...
export class GameScene extends Container {
  ...
  layout(screenWidth: number, screenHeight: number): void {
    ...
    this.holdWinMachine.scale.set(reelsScale)
    this.holdWinMachine.position.set(centerX, reelsCenterY)
