...
import { getLap, wrapOffset } from '#src/utils'
 ...
 */
describe('граница диапазона ленты', () => {
  it('сажает барабан верно с любой стартовой позиции', async () => {
  ...
  it('меняет круг ровно там же, где позиция переходит в начало диапазона', () => {
