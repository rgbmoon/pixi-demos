...
export type CanvasConfig = {
  ...
  fillMaxWidth: number
  /** Фиксированный логический размер рендера; CSS-размер канваса остаётся адаптивным. */
  designSize?: CanvasSize
  /** Масштабирует канвас в CSS без интерполяции пикселей. */
  pixelated?: boolean
  /** Сглаживание геометрии WebGL. */
  antialias?: boolean
  /** Округление экранных координат при отрисовке. */
  roundPixels?: boolean
}
